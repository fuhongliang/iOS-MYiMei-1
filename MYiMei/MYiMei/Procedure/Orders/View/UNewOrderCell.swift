...
class UNewOrderCell: BaseView {
    ...
    func setView() {
        ...
        self.addSubview(orderNumberLaber)
        ...
        self.addSubview(pendingPaymentLaber)
        ...
        userNameLaber.snp.makeConstraints { (ConstraintMaker) in
            ...
            ConstraintMaker.top.equalTo(grayBg.snp.top).offset(14)
        }
        //MARK:用户电话
        ...
        userPhoneLaber.snp.makeConstraints { (ConstraintMaker) in
            ...
            ConstraintMaker.top.equalTo(grayBg.snp.top).offset(15)
        }
        //MARK:联系收货人
        ...
        self.addSubview(contactReceiverLaber)
        ...
        self.addSubview(totalCommodity)
        ...
        modifyPriceBtn.setTitle("修改密码", for: UIControl.State.normal)
        ...
        self.addSubview(modifyPriceBtn)
